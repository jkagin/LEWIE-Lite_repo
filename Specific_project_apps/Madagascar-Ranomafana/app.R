...
sheet_location = "local"; sheet_path = "LEWIE-Lite_NewInput_v21_Ranomafana.xlsx"
# -----------------------------------------------------------------------------------------------------
# -----------------------------------------------------------------------------------------------------
    ...
    dashboardBody(
        tabItems(
            ...
            tabItem("data",
                ...
                p("Nevertheless, you can even change these inputs and explore what happens to the multipliers - but those changes cannot be saved.", style = "font-size:16px"),
                tabBox(
            ...
            tabItem("home",
                fluidPage(
                    ...
                    along with some simple scenario calculations. 
                      Scrolling down, you will find some local-economy multipliers calculated using the LEWIE-Lite model.", style = "font-size:18px"),
            ...
            tabItem("simulations",
                ...
                fluidRow(
                  box(width = 12, title = "Explore the local economy impacts of…",
                      ...
                      p(HTML("10. <a href='#sim_LocalGSpending'>Local Government Spending</a>"), style = "margin-left: 20px")
                  )
                ),
                fluidRow(
